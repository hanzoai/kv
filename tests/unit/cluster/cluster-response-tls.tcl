...
proc cluster_response_tls {tls_cluster} {
    ...
    test "CLUSTER SLOTS cached using EVAL over TLS -- tls-cluster $tls_cluster" {
        set client_tcp [kv 127.0.0.1 [srv 0 pport] 0 0]
        set client_tls [kv 127.0.0.1 [srv 0 port] 0 1]
    ...
    test "CLUSTER SLOTS with different connection type -- tls-cluster $tls_cluster" {
        ...
        set cluster_client [kv_cluster 127.0.0.1:$pport 0]
    ...
    set cluster_pport [kv_cluster 127.0.0.1:[srv 0 pport] 0]
