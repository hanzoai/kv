...
test "Pub/Sub shard basics" {
    ...
    set publishclient [kv_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeclient [kv_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeclient2 [kv_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set anotherclient [kv_deferring_client_by_addr $notshardnode(host) $notshardnode(port)]
...
test "Verify Pub/Sub and Pub/Sub shard no overlap" {
    ...
    set publishshardclient [kv_client_by_addr $publishnode(host) $publishnode(port)]
    set publishclient [kv_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeshardclient [kv_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeclient [kv_deferring_client_by_addr $publishnode(host) $publishnode(port)]
...
test "PUBSUB channels/shardchannels" {
    set subscribeclient [kv_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeclient2 [kv_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set subscribeclient3 [kv_deferring_client_by_addr $publishnode(host) $publishnode(port)]
    set publishclient [kv_client_by_addr  $publishnode(host) $publishnode(port)]
