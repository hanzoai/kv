...
start_server {tags {"modules"}} {
    ...
    test {startup moduleconfigs} {
        ...
        catch {exec $::KV_SERVER_BIN --moduleconfigs.string "hello"} err
        assert_match {*Module Configuration detected without loadmodule directive or no ApplyConfig call: aborting*} $err

        # Bad config value
        catch {exec $::KV_SERVER_BIN --loadmodule "$testmodule" --moduleconfigs.string "rejectisfreed"} err
        ...
        catch {exec $::KV_SERVER_BIN --loadmodule "$testmodule" noload --moduleconfigs.string "hello"} err
