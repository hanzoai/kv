...
This script spins up a kv-server and a kv-cli in order to obtain COMMAND DOCS.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--server', type=str, default='%s/kv-server' % srcdir)
    ...
    # Fetch schemas from a KV instance
